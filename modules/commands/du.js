...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "CallmeSun",
  description: "suỵt suỵt dưới 18 cút",
...
"https://i.imgur.com/yRBuo11.jpg",
 ...
 "https://i.imgur.com/vrVWU0V.jpg",
  ...
  var money = data.money
      if(money < 200) api.sendMessage("Bạn cần 200 đô để uống sữa :v",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 200})
   var callback = () => api.sendMessage({body:`chúc ngon miệng\n» Số dư: -200 đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
